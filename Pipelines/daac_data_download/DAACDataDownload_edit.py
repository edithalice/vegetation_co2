...
parser.add_argument('-n', '--num_files', required=False, help='Number of files to download', default =10000, type=int)
...
try:
    ...
    for i, f in enumerate(fileList):
        ...
        if not os.path.exists(saveName):
            print('Loading file: {}...'.format(saveName))
            ...
            if not downloaded_files%10:
                print(f'{i}/{total_files} total files downloaded')
    ...
    print(f'Downloaded {downloaded_files} files')
    print(f'{i}/{total_files} files have been downloaded')
    print(type(excep))
    print(excep)
